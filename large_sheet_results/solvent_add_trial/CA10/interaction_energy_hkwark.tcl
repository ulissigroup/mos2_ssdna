...
# mol addfile $folder/fixed_mos2_solvate_output/fixed_cnt_solvate.dcd waitfor -1
...
mol delete all
mol new $folder/structure_files/ssdna_mos2_ions_final.psf
mol addfile $folder/structure_files/ssdna_mos2_ions_fixed.pdb
mol addfile $folder/fixed_mos2_solvate_output/fixed_cnt_solvate.dcd waitfor -1 step 50
